...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              ...
              <p class="mb-0 font-weight-bold text-sm">
                Updating products information is a vital aspect of maintaining accurate and current medical records.
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1" role="tablist">
                <li class="nav-item">
                  <a href="{{route('product_information')}}" class="nav-link mb-0 px-0 py-1 active d-flex align-items-center justify-content-center " >View All Product Informations</a>
                </li>
                </li>
              </ul>
            </div>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-md-12">
          <form class="card" method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">@csrf @method('PATCH')
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <button class="btn btn-primary btn-sm ms-auto" type="submit">Update Product</button>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="tax" value="{{ $product->tax }}" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
